...
module.exports.PORT = process.env.PORT || "600";
module.exports.WEBUI_HOST = process.env.WEBUI_HOST || "0.0.0.0";
module.exports.PASSWORD_HASH = process.env.PASSWORD_HASH;
module.exports.WG_PATH = process.env.WG_PATH || "/etc/wireguard/";
module.exports.WG_DEVICE = process.env.WG_DEVICE || "eth0";
module.exports.WG_HOST = process.env.WG_HOST || "87.117.52.21";
module.exports.WG_PORT = process.env.WG_PORT || "900";
module.exports.WG_CONFIG_PORT =
  process.env.WG_CONFIG_PORT || process.env.WG_PORT || "900";
...
module.exports.WG_POST_UP =
  ...
  `
iptables -t nat -A POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replace(
    "x",
    "0"
...
module.exports.WG_POST_DOWN =
  ...
  `
iptables -t nat -D POSTROUTING -s ${module.exports.WG_DEFAULT_ADDRESS.replace(
    "x",
    "0"
  )}/24 -o ${module.exports.WG_DEVICE} -j MASQUERADE;
